  ...
  addHandlerClick(handler) {
    this._parentElement.addEventListener("click", (e) => {
      ...
      if (e.target.closest(".list__options-cta")) {
        const listsMenuEngaged = e.target.closest(".list");
        if (listsMenuEngaged.classList.contains("list--options-visible"))
          listsMenuEngaged.classList.remove("list--options-visible");
        else {
          qs(".list--options-visible")?.classList.remove("list--options-visible");
          listsMenuEngaged.classList.add("list--options-visible");
        }
        return;
      }
    });
