...
const createNewList = () => {
  ...
  listsContainer.insertAdjacentHTML("beforeend", markup);
...
const listAddButton = qs(".list-add");
listAddButton.addEventListener("click", createNewList);
